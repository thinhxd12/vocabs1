...
<div class="bg-[#19191c] w-full h-full flex relative z-20">
  <div
    class="w-[calc(100vw-360px)] h-full relative overflow-hidden flex items-center justify-center pt-60 pb-80 px-40"
  >
    <img
    ...
    />
    <div class="absolute top-6 right-6 z-9 flex gap-6">
      <button
        class="btn-menu"
        onclick={(e) => {
  ...
  <div class="w-[360px] h-full flex flex-col p-15">
      ...
      <div class="rounded-6 bg-white/15 p-3">
        <div class="flex">
          <img
            ...
            alt="author"
            class="size-45 rounded-6 object-cover shadow shadow-black/10"
          />
          <div>
